...
BEGIN
  ...
  INSERT INTO public.notifications(user_id, title, body, type, link) VALUES
    (buyer, 'Purchase successful', 'KSh ' || total::text || ' paid from your wallet.', 'payment', '/orders?order=' || order_id),
    (listing_row.user_id, 'Item sold', 'You received KSh ' || total::text || ' in your wallet.', 'payment', '/orders?order=' || order_id);
